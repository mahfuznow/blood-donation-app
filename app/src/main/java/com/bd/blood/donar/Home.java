...
//nav Drawer
        ...
        sendAP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (("DHAKA".equals(mydistrict) || "CHITTAGONG".equals(mydistrict)) && ("null".equals(mythana))) {
...
****/
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = new NotificationChannel("BD", "BloodDonor", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public void sendRequest(final String blood, final String name, final String phone, final String address) {
        ...
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Home.this);
